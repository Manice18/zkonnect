...
export const POST = async (
  ...
  try {
    ...
    try {
      ...
      // const sendNFT = await axios.get(
      //   "/api/sendNFT/?creatorAddress=" +
      //     eventAccount.creator.toString() +
      //     "&merkleTreeAddr=" +
      //     eventAccount.merkleTree.toString() +
      //     "&collectionNFTAddr=" +
      //     eventAccount.collectionNft.toString() +
      //     "&toUserAddr=" +
      //     account +
      //     "&eventName=" +
      //     eventAccount.eventName.toString(),
      // );
